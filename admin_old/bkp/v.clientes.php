<span class="tt_pg"><b>Lista de Clientes</b></span><br><br>
<?php
/*------------------------ ALTERAÇÕES ------------------*\
#22/06/2016{
	-Desenvolvido;
...
var dataSet = [
<?php
$cl1= mysql_query("select * from clientes");
 $od = 0;
...
$od++;//define ordem
	...
	$lk = "<img src=\'arquivos/icones/26.png\' class=\'bt_p\' title=\'Altera Dados do Cliente\' onclick=\'mostraEditaCliente($cli[id])\'>";
	$lk .= " <a href=\'index.php?pg=c.cliente&id=$cli[id]\' title=\'Ver Cliente\'><img src=\'arquivos/icones/1111.png\' class=\'bt_p\'></a>";
	echo "
	['$od','$cli[nome]','$cli[email]','$cli[tel1]/$cli[tel2]','$st','$lk',],";
}
?>
];
