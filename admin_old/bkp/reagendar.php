...
<div id="conteudo">
<div id="principal">
<span class="tt_pg"><b>Reagendamento</b></span><br>
<?php
echo "
<b>Dados Atuais</b><br>
<b>Data: </b>$ag[data] - $ag[hr_fim] <br>
...
<b>Nova Data</b> <input type="text" size="10" class="date" name="ndata" required><br>
<b>Hora Início</b> <input type="text" name="hora" class="hora" id="dt1" size="4" required ><br>
