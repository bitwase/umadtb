...
$etq = "<div style='text-align:center;width:$lar;height:$alt;margin-left:$dcol;background:#666;border-radius:5px; float:left; font-size:40px;font-color#fff;'>$nome</div>";
$cima .= $etq;
}
$mpdf->AddPage('P');
