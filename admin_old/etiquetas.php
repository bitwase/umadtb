...
6 - 14 etiquetas por página, TAMANHO CARTA pimaco 6182
*******************************/
...
//	$barras = "<img src='http://umadpguvaranas.com.br/jovens/image.php?code=code128&o=1&t=20&r=1&text=$cod&f=2&a1=&a2='/>";
//	$barras = "<img src='http://umadpguvaranas.com.br/jovens/image.php?code=code100&o=1&t=20&r=1&text=$cod&f=2&a1=&a2='/>";
#	$barras = "<br><b>Você é Especial!</b><br>Deus te escolheu para estar aqui!<br><span style='font-size:12px;'>$ls[setor]</span>";
	$barras = "<br><b>Você é Especial!</b><br>Deus te escolheu para estar aqui!";
}
$etq = "<div style='text-align:center;width:$lar;height:$alt;margin-left:$dcol;background:#fff;border-radius:5px; float:left;font-size:14px;'>$nome<br>$barras</div>";
$cima .= $etq;
}
$mpdf->AddPage('P');
