...
$m1=mysql_query("
select *, upper(nome) as 'nome' from tb_inscritos where id in(select inscrito from tb_inscricao where evento = '$ev') $congr order by nome
");
...
<div style='position:relative;font-size:12px;margin-left:560px;z-index:1;margin-top:-17px;'>Assinatura</div>
</b><hr>
";
$inscritos = "";
...
<div style='position:relative;font-size:12px;margin-left:360px;z-index:1;margin-top:-17px;'>$telefone</div>
<div style='position:relative;font-size:12px;margin-left:560px;z-index:1;margin-top:-17px;'> __________________</div>
";
}
