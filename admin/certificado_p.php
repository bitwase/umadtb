...
//	$rg = $si[regional];//nome da regional...
	certificado($fl,$ev,$cn);
//}
//}//fim dados preenchidos

function certificado($fl,$ev,$cn){//rg = regional
...
$nome1 = "<tocentry content='A4 landscape' />
<div style='position:absolute;text-align:left;left:490px;top:394px;width:553px;font-family:Arial Black;font-size:24;text-indent: 2.0em;'> <b>$nom</b></div>";
