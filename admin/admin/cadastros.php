...
$idsGrid = "2"; //se houver mais de uma, separar por vírgula.
    ...
    function dadosCadastros() {
        $(document).ready(function() {
            ...
            function salvar() {
                ...
                localStorage["kendo-grid-options-cadastros"] = xpt;
                //  alert(xpt);
            ...
            function load() {
                var options = localStorage["kendo-grid-options-cadastros"];
                if (options) {
